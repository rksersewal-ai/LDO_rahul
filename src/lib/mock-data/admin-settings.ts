...
export const MOCK_ROLE_PERMISSIONS: RolePermissionMatrix = {
  ...
  reviewer: ["documents.view", "documents.create", "pl.create", "bom.edit", "approvals.approve"],
  engineer: ["documents.view", "documents.create", "pl.create", "bom.edit"],
  viewer: ["documents.view"],
  classification_officer: ["documents.view", "documents.classify"],
  records_manager: ["documents.view", "records.manage"],
  legal_hold_officer: ["documents.view", "legal_hold.manage"],
  auditor: ["documents.view", "audit.view"],
};

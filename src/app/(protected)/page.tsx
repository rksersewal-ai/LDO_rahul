...
const KPI_SKELETON_KEYS = ["kpi-a", "kpi-b", "kpi-c", "kpi-d", "kpi-e"];
const ACTIVITY_SKELETON_KEYS = ["act-a", "act-b", "act-c", "act-d"];
const DOC_SKELETON_KEYS = ["doc-a", "doc-b", "doc-c", "doc-d", "doc-e"];

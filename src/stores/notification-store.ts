...
const mockNotifications: Notification[] = [
  ...
  {
    id: "n-work-1",
    title: "Work Assigned: Drawing Review",
    context: "CLW-TM-GA-001-R3 assigned by Shri A.K. Verma",
  ...
  {
    id: "n-work-2",
    title: "Work Assigned: Spec Amendment",
    context: "CLW/EL/SPEC/INS-RES/2023 assigned by Shri R.K. Sharma",
    timestamp: "2 hr ago",
    group: "action",
    read: false,
    actionLabel: "Open",
  ...
  },
  {
    ...
    context: "Tender Evaluation CLW/EL/TENDER/2024/0601 due in 2 days",
    timestamp: "4 hr ago",
    group: "action",
    read: false,
    actionLabel: "View",
  ...
  {
    id: "n-work-4",
    title: "Overdue Work Alert",
    context: "PL Revision Processing (7 days overdue) needs attention",
    timestamp: "1 day ago",
    group: "action",
    read: false,
    actionLabel: "Open",
